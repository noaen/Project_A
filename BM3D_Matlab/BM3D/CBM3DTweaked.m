function [PSNR, yRGB_est] = CBM3D(yRGB, zRGB,zRGBblurred, sigma, profile, print_to_screen, colorspace)
%
...
[zColSpaceBlurr l2normLumChromBlurr] = function_rgb2LumChrom(zRGBblurred, colorspace);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%
tic;
yRGB_est = bm3d_wiener_color(zColSpace, single(zColSpaceBlurr), hadper_trans_single_den, Nstep_wiener, N1_wiener, N2_wiener, ...
