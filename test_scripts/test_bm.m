...
orig_names_list = {'orig_lvl_4', 'orig_lvl_5', 'orig_lvl_6','orig_lvl_7'};
lr_names_list = {'lr_lvl_4', 'lr_lvl_5', 'lr_lvl_6','lr_lvl_7'};
hr_names_list = {'hr_lvl_4', 'hr_lvl_5', 'hr_lvl_6','hr_lvl_7'};
...
for i = 1:length(orig_names_list)
    ...
    [fig1, fig2] = draw_bm(strcat('../Data/csv_files/',folder_list{j},'patch_', lr_names_list{i},'.csv'),...
    ...
    [fig1, fig2] = draw_bm(strcat('../Data/csv_files/',folder_list{j},'patch_', hr_names_list{i},'.csv'),...
    ...
    [fig1, fig2] = draw_bm(strcat('../Data/csv_files/',folder_list{j},'patch_', orig_names_list{i},'.csv'),...
